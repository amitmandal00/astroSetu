    ...
    <div className="grid gap-5">
      <div className="rounded-3xl bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white p-6 lg:p-8 mb-6 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl lg:text-4xl font-bold mb-2">Testimonials</h1>
          <p className="text-white/90 text-base">
            What our users say about AstroSetu
          </p>
        </div>
      </div>
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-slate-600 mb-6">
              Customer testimonials and reviews will be available here soon!
            </p>
            <a
              href="/"
