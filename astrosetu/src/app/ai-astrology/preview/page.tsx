...
function PreviewContent() {
  ...
  const generateReport = useCallback(async (inputData: AIAstrologyInput, type: ReportType, currentSessionId?: string, currentPaymentIntentId?: string) => {
    ...
    // When generateReport is called from payment verification or setTimeout flows,
    // loadingStartTime may already be set. Resetting it would cause the timer to reset to 0.
    // Only set it if it's null/undefined, indicating this is the start of generation
