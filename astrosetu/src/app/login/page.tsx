            ...
            <div className="flex items-start gap-2 mb-2">
              <input
                ...
                onChange={(e) => {
                  ...
                  // Log both Terms and Privacy consent when checkbox is checked
                  if (checked) {
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><div className="text-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-saffron-600 mx-auto mb-4"></div><div className="text-slate-600">Loading authentication...</div></div></div>}>
      <LoginPageContent />
    </Suspense>
  );
}
