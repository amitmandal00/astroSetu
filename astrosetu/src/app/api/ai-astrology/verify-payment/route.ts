...
export async function GET(req: Request) {
  ...
  try {
    ...
    // We must handle it as a test session, regardless of ALLOW_PROD_TEST_BYPASS flag
    // The flag controls whether to CREATE prodtest_ sessions, not whether to VERIFY them
    // test_session_ always bypasses (demo mode)
    // prodtest_ always bypasses (it's a mock session created by create-checkout)
