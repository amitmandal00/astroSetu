        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs text-slate-600">
              <Link href="/privacy" target="_blank" rel="noreferrer noopener" className="hover:text-saffron-600 transition-colors">
                Privacy
              </Link>
              <Link href="/terms" target="_blank" rel="noreferrer noopener" className="hover:text-saffron-600 transition-colors">
                Terms
              </Link>
              <Link href="/disclaimer" target="_blank" rel="noreferrer noopener" className="hover:text-saffron-600 transition-colors">
                Disclaimer
              </Link>
              <Link href="/refund" target="_blank" rel="noreferrer noopener" className="hover:text-saffron-600 transition-colors">
                Refund
              </Link>
              <Link href="/cookies" target="_blank" rel="noreferrer noopener" className="hover:text-saffron-600 transition-colors">
                Cookies
              </Link>
            </div>
          </div>
